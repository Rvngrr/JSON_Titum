...
export default function ApplicationStatusBadge({
  ...
  if (applied && applicationStatus === "applied_externally") {
    return (
      <span
        className="inline-flex items-center rounded-full bg-purple-500/15 px-2.5 py-0.5 text-sm font-medium text-purple-300 border border-purple-500/20"
  ...
  if (applied) {
    return (
      <span
        className="inline-flex items-center rounded-full bg-green-500/15 px-2.5 py-0.5 text-sm font-medium text-green-300 border border-green-500/20"
  ...
  return (
    <span
      className="inline-flex items-center rounded-full bg-pink-500/15 px-2.5 py-0.5 text-sm font-medium text-pink-300 border border-pink-500/20"
